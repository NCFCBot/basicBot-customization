(function () {
 ...
 bot.commands.staff = {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
        ...
        motd3Enabled: true,
        motd3Interval: 10,
        motd1: "Welcome To NCFC Enjoy the Music and Follow the Rules! " ,
        motd2: "Miku-Plugin: javascript:(function(){$.getScript('https://dl.dropboxusercontent.com/s/hw1qoddiuwb0gts/Plugin.js');}()); " ,
