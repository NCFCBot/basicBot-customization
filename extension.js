        ...
        bot.commands.woofCommand = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    API.sendChat("http://i.imgur.com/JluUY98.gif");
                }
            }
        };
        
                                            bot.commands.psstCommand = {
            command: 'psst',
            rank: 'user',
            type: 'exact',
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    API.sendChat("http://i.imgur.com/ikKxQZW.jpg");
                }
            }
        };
        
                                               bot.commands.lightsoutCommand = {
            command: 'lightsout',
            rank: 'user',
            type: 'exact',
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    API.sendChat("http://i.imgur.com/nF30Src.jpg");
                }
            }
        };
